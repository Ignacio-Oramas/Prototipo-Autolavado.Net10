...
namespace autolavado.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Placa,Modelo,Color,ClientId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Placa,Modelo,Color,ClientId")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
